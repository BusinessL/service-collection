...
import (
	...
	pb "service-collection/services/helloworld/proto"
	grpclb "service-collection/components"
)

var (
	serv = flag.String("service", "hello_service", "service name")
	host = flag.String("host", "localhost", "listening host")
	port = flag.String("port", "50003", "listening port")
	reg  = flag.String("reg", "http://localhost:2380", "register etcd address")
)
